...
def main():
    ...
    def abrir_editar_janela():
        ...
        # Janela de edição.
        edit_janela = CTkToplevel(janela)
        ...
        # Botão para salvar alterações ao editar.
    ...
    def salvar_edicao(despesa_id, valor_entry, categoria_entry, data_entry, desc_entry, janela_edicao):
        try:
            ...
            services.atualizar_despesa(despesa_id, valor, categoria, data, descricao) # Chamar função de atualização.
            janela_edicao.destroy()
            services.listar_despesas() # Request listagem de services.
        except ValueError:
    ...
    def abrir_despesas_janela():
        global tree
        # Janela de despesas.
        despesas_janela = Toplevel(janela)
        ...
        def listar_despesas_tabela():
            ...
            for despesa in services.listar_despesas():
        ...
        def pesquisar_despesas():
            ...
            tree.delete(*tree.get_children())
            for despesa in services.listar_despesas(): # Request listagem de services.
        ...
        def acao_remover():
            ...
            if resposta:
                services.remover_despesa(despesa_id) # Chamar função deletar de services
                listar_despesas_tabela()
                atualizar_total()
    ...
    def adicionar_despesas():
        try:
            ...
            services.inserir_despesa(valor, categoria, data, descricao) # Enviar para services.
    ...
    def atualizar_total():  # Lado front-end da função de atualização.
        despesas = services.listar_despesas() # Request de listagem.
    ...
    # Centralizar janela de acordo com tela.
    def centralizar_janela(janela, largura=450, altura=480):
        alt_ = janela.winfo_screenheight()
        larg_ = janela.winfo_screenwidth()
        x = (larg_ - largura) // 2
        y = (alt_ - altura) // 2
    ...
    totalLabel.place(x=95, y=330)

    mediaLabel = CTkLabel(frame_principal, text="Média Diária: R$0.00", font=('Helvetica', 14, 'bold'))
    mediaLabel.place(x=95, y=360)

    # Logo do grupo com tratamento de erro.
    try:
        img = Image.open("taskforce_logo.png")
